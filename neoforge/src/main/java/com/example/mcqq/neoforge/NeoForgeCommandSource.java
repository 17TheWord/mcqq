...
/**
 * What a command caller looks like on NeoForge — the two things the core's command policy needs from a platform.
 *
 ...
 */
final class NeoForgeCommandSource implements CommandSource {

    private final CommandSourceStack source;

    NeoForgeCommandSource(CommandSourceStack source) {
        this.source = source;
    }
